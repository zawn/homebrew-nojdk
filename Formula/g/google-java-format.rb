class GoogleJavaFormat < Formula
  ...
  url "https://github.com/google/google-java-format/releases/download/v1.34.0/google-java-format-1.34.0-all-deps.jar"
  ...
  resource "google-java-format-diff" do
    url "https://raw.githubusercontent.com/google/google-java-format/v1.34.0/scripts/google-java-format-diff.py"
